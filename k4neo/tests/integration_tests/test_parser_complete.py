...
class TestBinaryKmerIndexResultPaser:
    ...
    def test_parsing_raptor_sequential(self):
        parser = BinaryKmerIndexResultParser(
            pathlib.Path(__file__).parent.parent
            / "resources"
            / "example_index_output"
        ...
        results = []
        for this_cts, this_samples in parser.stream_results():
            results.append(this_cts)
            results.append(this_samples)
    ...
    def test_parsing_kmindex_sequential(self):
