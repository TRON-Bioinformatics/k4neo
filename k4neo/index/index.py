...
class KmerIndex(object):
    def __init__(self,
        ...
        self.pipeline_config = QueryPipelineConfig(index=index, method=method, kmer_ratio=kmer_ratio)

    def search_index(self, query_sequences: pathlib.Path, working_dir: pathlib.Path, slurm=True):
