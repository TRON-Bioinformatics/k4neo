...
**Predicting tumor-specificity in a blast: A modern k-mer based approach to screen for (novel) transcript sequences in healthy and tumor tissue RNA-seq.**
...
k4neo stores metadata of indexed samples in a SQLite3 database ([`k4neo-database`](usage.md#k4neo-database)). Please refer to the [k4neo-index-data](https://github.com/TRON-Bioinformatics/k4neo-index-data) repository for information about structured metadata and how to build the database. The database schema documentation will follow.
